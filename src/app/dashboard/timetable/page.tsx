...
export default function TimetablePage() {
  ...
  const handleAddSlot = async (e: React.FormEvent) => {
    ...
    try {
      ...
      fetchTimetable();
      setNewSlot({ ...newSlot, subject: "", teacher: "", room: "", startTime: "09:00", endTime: "10:00", branch: selectedBranch, semester: selectedSem });
    } catch (error) {
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'timetable' ? (
                           ...
                           <div className="space-y-0.5">
                              ...
                              <div className="flex flex-wrap items-center gap-3">
                                 <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-xs font-medium text-slate-400">{slot.teacher}</span>
                                 </div>
                                 <div className="flex items-center gap-1.5">
                                    <MapPin size={12} className="text-indigo-400" />
                                    <span className="text-xs font-medium text-slate-400">{slot.room}</span>
                                 </div>
                              </div>
                           </div>
                        </div>
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="h-64 flex items-center justify-center bg-slate-900/50 rounded-lg border border-white/5"
          >
             <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-xs text-slate-400 text-center px-4">Leaderboard data will be available at the end of the semester.</p>
             </div>
          </motion.div>
        )}
      </AnimatePresence>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                       ...
                       <select 
                         ...
                         onChange={e => setNewSlot({...newSlot, semester: e.target.value})}
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                       ...
                       <select 
                         ...
                         onChange={e => setEditingSlot({...editingSlot, semester: e.target.value})}
                         className="w-full bg-slate-950 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-indigo-500 transition-all"
                       >
